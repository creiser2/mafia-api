Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = ['https://mafia-game.herokuapp.com', 'http://mafia-game.herokuapp.com']
  ...
  # config.active_job.queue_name_prefix = "mafia-api_#{Rails.env}"
